...
def main():
    ...
    if userinput == 3 or userinput == 4:
        ...
        # should be adultprepout_Male.csv and adultprepout_Female.csv
        m_file = "adultprepout_Male.csv"
        f_file = "adultprepout_Female.csv"
        
        # load the datasets with first row as column names
        # dataset has 0 - <= 50K and 1 - > 50K
        ...
        m_y1 = m_dataframe['class']
        f_y1 = f_dataframe['class']
        ...
        # define the location of the dataset
        # file should be adultprepout.csv
        file = "adultprepout.csv"
