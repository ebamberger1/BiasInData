...
def main():
    ...
    if userinput == 3 or userinput == 4:
        ...
        # should be compasprepout_Male.csv and compasprepout_Female.csv
        m_file = "compasprepout_Male.csv"
        f_file = "compasprepout_Female.csv"
        ...
        col_names.remove('sex_Male') # not using gender when training split models
        ...
        m_y1 = m_dataframe['two_year_recid']
        f_y1 = f_dataframe['two_year_recid']
        ...
        if userinput == 1: # using cross_validate method - does automatically on each fold
            ...
            if userinput == 5:    
                ...
                new_cols.remove('sex_Male')
            
                scores, coefsums, predictedvalues, predictedprobs, intercept = manual_cross_validation_merge(X1, y1, col_names, new_cols, col_names.index('sex_Male')) 
            ...
            # A tuple is female if sex_Male is 0
            f_rows = dataframe[dataframe.sex_Male == 0]
            
            # list of actual classification values for female tuples
            f_y1 = list(f_rows['two_year_recid'])
            ...
            # A tuple is male if sex_Male is 1
            m_rows = dataframe[dataframe.sex_Male == 1]
            
            # list of actual classification values for male tuples
            m_y1 = list(m_rows['two_year_recid'])
